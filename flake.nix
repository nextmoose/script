        ...
        { self , nixpkgs , flake-utils , shell } :
		  ...
		  builtins.getAttr
		    ...
		    (
			  ...
			  program3 = "${ structures.pkgs.coreutils }/bin/echo 31bca02094eb78126a517b206a88c73cfa9ec6f704c7030d18212cace820f025f00bf0ea68dbf3f3a5436ca63b53bf7bf80ad8d5de7d8359d0b7fed9dbc3ab99" ;
			}
		    )
